...
.p-MenuBar-item, .lm-MenuBar-item { color: #666 !important; background: transparent !important; font-size: 12px !important; font-weight: 500 !important; border-radius: 4px !important; padding: 4px 10px !important; }
...
.p-Menu-itemShortcut, .lm-Menu-itemShortcut { color: #555 !important; font-size: 10px !important; }
...
.theia-app-sides .p-TabBar-tab:hover, .theia-app-sides .lm-TabBar-tab:hover { background: rgba(255,255,255,0.06) !important; }
.theia-app-sides .p-TabBar-tab.p-mod-current, .theia-app-sides .lm-TabBar-tab.lm-mod-current { background: rgba(255,255,255,0.08) !important; }
.theia-app-sides .p-TabBar-tab.p-mod-current::after, .theia-app-sides .lm-TabBar-tab.lm-mod-current::after {
    ...
    top: 25% !important; bottom: 25% !important; width: 2px !important; background: #fff !important; border-radius: 1px !important;
}
...
.p-TabBar:not(.theia-app-sides), .lm-TabBar:not(.theia-app-sides) {
    background: #080808 !important; border-bottom: 1px solid var(--79-border) !important; padding: 4px 8px 0 !important;
}
...
.p-TabBar:not(.theia-app-sides) .p-TabBar-tab, .lm-TabBar:not(.theia-app-sides) .lm-TabBar-tab {
    background: transparent !important; border: none !important; border-radius: 6px 6px 0 0 !important; padding: 5px 16px !important; position: relative !important;
}
.p-TabBar:not(.theia-app-sides) .p-TabBar-tab:hover, .lm-TabBar:not(.theia-app-sides) .lm-TabBar-tab:hover { background: rgba(255,255,255,0.03) !important; }
.p-TabBar:not(.theia-app-sides) .p-TabBar-tab.p-mod-current, .lm-TabBar:not(.theia-app-sides) .lm-TabBar-tab.lm-mod-current { background: #0e0e0e !important; }
.p-TabBar:not(.theia-app-sides) .p-TabBar-tab.p-mod-current::after, .lm-TabBar:not(.theia-app-sides) .lm-TabBar-tab.lm-mod-current::after {
    content: '' !important; position: absolute !important; bottom: 0 !important; left: 20% !important; right: 20% !important; height: 1px !important; background: #fff !important;
}
.p-TabBar-tabLabel, .lm-TabBar-tabLabel { font-size: 12px !important; color: #555 !important; }
.p-TabBar-tab.p-mod-current .p-TabBar-tabLabel, .lm-TabBar-tab.lm-mod-current .lm-TabBar-tabLabel { color: #fff !important; font-weight: 500 !important; }
...
.theia-input:focus, .monaco-inputbox.synthetic-focus .input { border-color: rgba(255,255,255,0.2) !important; }
...
/* ===== COMMAND PALETTE ===== */
.monaco-quick-input-widget { background: #0e0e0e !important; border: 1px solid rgba(255,255,255,0.1) !important; border-radius: 10px !important; }

/* ===== AI CHAT ===== */
.theia-ChatView, .ai-chat-view, #ai-chat-view { background: #080808 !important; }

/* Hide default welcome text and agent suggestions */
...
.theia-WelcomeMessage-Container::before {
    ...
    background: linear-gradient(90deg, #222 0%, #555 20%, #fff 50%, #555 80%, #222 100%) !important;
    background-size: 300% 100% !important;
    -webkit-background-clip: text !important;
    -webkit-text-fill-color: transparent !important;
    background-clip: text !important;
    animation: shimmer79 4s linear infinite !important;
}
...
.welcome-page-root {
    ...
    height: 100%; padding: 40px 20px; background: #000; overflow-y: auto; color: #fff;
    font-family: var(--79-font);
}
.welcome-logo {
...
.welcome-logo-text {
    font-size: 96px; font-weight: 800; letter-spacing: -6px; color: #fff; user-select: none; line-height: 1;
}
.welcome-subtitle {
    font-size: 11px; margin-bottom: 56px; letter-spacing: 6px; font-weight: 500; text-transform: uppercase;
}
/* Welcome subtitle also shimmers */
.welcome-shimmer {
    background: linear-gradient(90deg, #222 0%, #555 20%, #fff 50%, #555 80%, #222 100%) !important;
    background-size: 300% 100% !important;
    -webkit-background-clip: text !important;
...
.welcome-action-card:hover {
    border-color: rgba(255,255,255,0.15); background: #151515; transform: translateY(-2px);
}
.welcome-action-icon {
...
.welcome-quickstart-title { font-size: 10px; font-weight: 600; color: #444; text-transform: uppercase; letter-spacing: 3px; margin-bottom: 14px; }
.welcome-shortcut-list { list-style: none; padding: 0; margin: 0; }
.welcome-shortcut-item { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.04); }
.welcome-shortcut-item:last-child { border-bottom: none; }
.welcome-shortcut-label { color: #888; font-size: 12px; }
.welcome-shortcut-key { font-family: var(--79-mono); font-size: 10px; padding: 2px 8px; background: #1c1c1c; border: 1px solid rgba(255,255,255,0.06); border-radius: 4px; color: #aaa; }
